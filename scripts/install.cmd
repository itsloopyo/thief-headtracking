...
:: --- CONFIG BLOCK ---
set "GAME_ID=thief"
set "MOD_DISPLAY_NAME=Thief Head Tracking"
set "MOD_DLLS=ThiefHeadTracking.asi"
set "MOD_INTERNAL_NAME=ThiefHeadTracking"
...
:: Shipping-ThiefGame.exe imports DINPUT8.dll directly, in both its 32- and
:: 64-bit builds.
set "ASI_LOADER_NAME=dinput8.dll"
:: Subdirectory below the exe directory to deploy into, for engines that load
:: their proxy DLL from somewhere other than beside the exe. Empty here: the
:: exe directory games.json points at is Binaries2\Win64, which is where the
:: game process runs from and where the loader has to sit.
set "ASI_SUBDIR="
...
set "MOD_CONTROLS=Controls (nav cluster / chord):&echo   End      / Ctrl+Shift+Y  Toggle tracking&echo   PageUp   / Ctrl+Shift+G  Cycle tracking mode&echo   PageDown / Ctrl+Shift+H  Toggle yaw mode&echo   Insert   / Ctrl+Shift+U  Cycle ADS mode"
:: --- END CONFIG BLOCK ---
